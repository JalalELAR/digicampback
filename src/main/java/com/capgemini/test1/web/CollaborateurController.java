...
public class CollaborateurController {
    ...
    public ResponseEntity<Collaborateur> createCollaborateur(
            ...
            @RequestBody List<Long> technologieIds) throws IOException {

        byte[] image = Base64.getDecoder().decode(Image);
        List<Technologie> technologies = technologieRepository.findAllById(technologieIds);
        Collaborateur collaborateur = iCollaborateurServiceImpl.createCollaborateur(nom, email, image,gradeId, siteId, technologies);
    ...
    @PutMapping("/{id}")
    public Optional<Collaborateur> updateCollaborateur(@PathVariable Long id, @RequestBody Collaborateur collaborateurDetails) {
        iCollaborateurServiceImpl.AssigneCount();
    ...
    public List<Collaborateur> searchCollaborateurs(
        ...
        iCollaborateurServiceImpl.AssigneCount();
        return iCollaborateurServiceImpl.searchCollaborateurs(nom, email, siteName, gradeName, technologieName);
    }
